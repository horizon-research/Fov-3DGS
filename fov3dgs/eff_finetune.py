    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        while network_gui.conn != None:
            try:
                ...
                if custom_cam != None:
                    net_image = render(custom_cam, gaussians, pipe, background, scaling_modifer, only_train_shs_dc=False)["render"]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--hvs_ft', action='store_true', default=False)
