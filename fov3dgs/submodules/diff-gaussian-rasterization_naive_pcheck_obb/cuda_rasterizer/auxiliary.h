...
__device__ const float real_image_width = 2.0f;
__device__ const float real_viewing_distance = 1.0f;
// __device__ const float sqrt_max_ps = 4.898979485566356f;
__device__ const float sqrt_max_ps = 3.4641016151377544f;
__device__ const float start_blend = 0.5f;
__device__ const float blend_width = 0.5f;
